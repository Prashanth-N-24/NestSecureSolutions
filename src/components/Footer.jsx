...
const Footer = () => {
  return (
    ...
    <SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(0, 229, 255, 0.8)">
        ...
        <div className='w-full flex flex-col sm:max-w-screen-xl sm:mx-auto items-center pt-4  sm:h-[32vh] h-[40vh]  '>

          <h1 className='pt-2 pl-2 text-5xl'>NestSecure</h1>
          ...
          <div className='my-4 flex flex-col items-center justify-center sm:flex sm:justify-between'>
            ...
            <div className='social_icons py-2 max-w-screen-xl sm:flex flex flex-row'>
          ...
          {/* <span className='pt-5'>Protect your Home from theaf</span> */}
        </div>
      </SpotlightCard>  
      </div>
    </>
